import { now, site } from '../content/site';
...
export function NowFooter() {
  return (
    ...
    >
      <div>
        <Eyebrow className="mb-2 text-accent lg:mb-2.5">{now.label}</Eyebrow>
        <p className="mb-[18px] max-w-[34em] text-body-sm/[1.7] text-ink-body text-pretty lg:mb-0 lg:text-body/[1.7]">
          <span className="lg:hidden">{now.bodyShort}</span>
          <span className="hidden lg:inline">{now.body}</span>
        </p>
      </div>
