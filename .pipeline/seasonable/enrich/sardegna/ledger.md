...
## 2026-09-17 — pat judge, pages 2, 4, 6, 12, 13, 15, 17, 19, 20, 22, 23, 25, 26, 28, 29, 30, 31, 33, 34 (sonnet/low, $0.356 so far)

- **Agrumi, Arancio di Muravera** (p.2) — `rejected`. states maturazione dates, not a raccolta/harvest statement. «Maturazione da metà dicembre a marzo. … possono conservarsi sulla pianta sino a tutto luglio»
- **Asparago selvatico** (p.5) — `rejected`. out of scope: wild plant gathered. «I turioni vengono raccolti teneri, mediamente lunghi 20-30 cm.»
- **Capperi e capperoni di Selargius** (p.6) — `candidate` open-field 9→16. «La raccolta dei capperi avviene in modo scalare, inizia l’ultima settimana di maggio e si conclude nella prima decade di settembre.»
- **Cece di Musei – Cixiri de Musei** (p.12) — `rejected`. dried pulses harvested dry for threshing. «La raccolta si esegue manualmente o meccanicamente (preferibilmente nelle prime ore del mattino) nei mesi di Giugno – Luglio, al termine del completo disseccamento delle piante.»
- **Cicerchia sarda** (p.14) — `rejected`. dried pulses/grains harvested dry for threshing. «La raccolta manuale avviene quando le piante sono in fase di senescenza ma non ancora completamente disseccate (melòngia), e consiste nell’estirpatura dell’intera pianta»
- **Ciliegio Furistera – Varietà locale di ciliegia** (p.20) — `rejected`. a point in time, not a window (maturazione, not raccolta). «L’epoca di maturazione cade attorno alla seconda decade di giugno.»
- **Cipolla di Gonnosfanadiga - Cibudda de Gonnosfanadiga** (p.23) — `candidate` open-field 8→11. «Ha un ciclo a giorno lungo con semina fine estate e raccolta a maggio-giugno. … La raccolta dei bulbi da conservazione si effettua tradizionalmente il 24 giugno per la festa di San Giovanni.»
- **Cipolla di San Giovanni (Suergiu)** (p.25) — `rejected`. start with no stated end: 'si raccolgono da metà maggio in poi'. «Si piantano da metà/fine ottobre sino a gennaio e si raccolgono da metà maggio in poi, soprattutto nel periodo a ridosso di San Giovanni Battista, secondo la stagione»
- **Cipolla rossa – Varietà locale di cipolla** (p.28) — `candidate` open-field 8→11. «La raccolta avviene nel periodo di maggio giugno.»
- **Fagiolo Bianco di Fluminimaggiore** (p.34) — `rejected`. dried pulses harvested dry for threshing/autoconsumo. «La raccolta avviene a tre mesi dalla semina.»
- **Ciliegia Barracocca di Villacidro - Cerexia Barracocca di Villacidro** (p.17) — `candidate` open-field 8→10. «La cerexia barracocca di Villacidro è una ciliegia tardiva, matura e viene raccolta tra fine maggio e inizi di giugno.»
- **Ciliegia di Burcei – Cerexia de Brucei** (p.19) — `silent`. no dated harvest window stated, only that cherries are picked ripe.
- **Ciliegio – Carruffale – Ciliegia tardiva** (p.22) — `silent`. only flowering date given, no harvest date stated.
- **Confettura di mela cotogna** (p.29) — `silent`. processed product; no dated harvest window given.
